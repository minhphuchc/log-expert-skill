---
name: log-expert
description: Chuyên gia phân tích log hệ thống trên GCE, hỗ trợ Docker logs và gửi báo cáo qua Discord. Kích hoạt khi cần kiểm tra sức khỏe các server (wsz-server, wsz-web-us, wsz-web-sea), điều tra lỗi ứng dụng (JSON, OpenAI, DB, OOM, CPU, Stacktrace, Anomaly), hoặc tổng hợp báo cáo log Senior SRE level.
---
...
- Kiểm tra log hoặc tình trạng của các server trọng yếu: `wsz-server`, `wsz-web-us`, hoặc `wsz-web-sea`.
...
| **wsz-web-us** | us-central1-a | Server xử lý dữ liệu (US) |
| **wsz-web-sea** | asia-southeast1-a | Server khu vực Đông Nam Á |
